...
export default function PrivacyPolicy() {
  return (
    <div className="container mt-5">
      ...
      <p>
        This privacy policy sets out how NewsZap uses and protects any information
        that you give NewsZap when you use this website.
      </p>
      <p>
        NewsZap is committed to ensuring that your privacy is protected. Should we
      ...
      <p>
        NewsZap may change this policy from time to time by updating this page.
        You should check this page from time to time to ensure that you are happy
        with any changes. This policy is effective from [date].
      </p>
      ...
      <p>
        ...
        you provide whilst visiting such sites and such sites are not governed by
      ...
      <ul>
        ...
        <li>
          ...
          writing to or emailing us at [vishal.it63@gmail.com]
        </li>
      </ul>
      <p>
      ...
      <p>
        ...
        would like a copy of the information held on you please write to [vishal.it63@gmail.com].
      </p>
      <p>
