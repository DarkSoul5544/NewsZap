...
const News = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`https://newsapi.org/v2/top-headlines?category=${category}&country=in&apiKey=c5e36d2b53594f76843004cf841cecbe&page=${page}&pageSize=6`);
  ...
  const handleImageError = (event) => {
    event.target.src = 'https://images.news18.com/ibnlive/uploads/2024/04/oneplus-11-india-price-cut-2024-2024-04-5de3815c40fd693eba7e44b9214c70f0.jpg?impolicy=website&width=640&height=480';
  };
