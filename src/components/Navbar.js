      ...
      <div className="container-fluid">
        ...
        <div className={`collapse navbar-collapse ${isCollapsed ? '' : 'show'}`} id="navbarSupportedContent">
          ...
          {/* <div className="navbar-nav ml-auto">
            {isLoggedIn ? (
              <>
                <a className="nav-link text-light" href="/profile">My Profile</a>
                {userRole === 'higher-admin' || userRole === 'administrator' ? (
                  <a className="nav-link text-light" href="/admin">Admin Panel</a>
                ) : null}
